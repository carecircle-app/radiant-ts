...
export function Page() {
  return (
    <Container className="p-6">
      <h1 className="text-2xl font-semibold">Coordinate care with confidence</h1>
      <div className="mt-6"><StripeCTAButtons /></div>
      <div className="mt-10"><Testimonials /></div>
      <div className="mt-6"><Link href="/admin" className="underline">Open Admin</Link></div>
    </Container>
  );
}
...
export const metadata = {
  ...
  description:
    "Shared calendar, medication reminders, geofencing alerts, and secure chat â€” built for families and caregivers.",
};
          ...
          <Container className="mx-auto max-w-6xl px-6 pb-20">
            ...
            <div className="mt-4 space-y-3">
              ...
              <details className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                ...
                <p className="mt-2 text-sm text-slate-600">Yes â€” subscriptions are month-to-month.</p>
              </details>
            </div>
          </Container>
        </section>
